...
class BASE(object):
    ...
    def image_file(self, ind):
        ...
        return image_id
    def lstm_list(self,ind):

        return self._lstm_list[ind]
    ...
    def shuffle_inds(self, quiet=False):
        ...
        rand_perm = self._data_rng.permutation(len(self._lstm_inds))
        self._lstm_inds = self._lstm_inds[rand_perm]
