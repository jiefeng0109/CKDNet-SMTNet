...
class Config:
    def __init__(self):
        ...
        self._configs["tensor_dir"] = "tensor"
        self._configs["list_dir"] = "src"
        ...
        self._configs["mode"] = "ms"

        cfg_file = os.path.join("config/cnn.json")
    ...
    def snapshot_dir(self):
        snapshot_dir = os.path.join(self.cache_dir, "nnet", self.snapshot_name+'-{}'.format(self.mode))
    ...
    @property
    def tensor_dir(self):
        return self._configs["tensor_dir"]
