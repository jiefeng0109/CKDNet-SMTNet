...
class DETECTION(BASE):
    def __init__(self, db_config):
        ...
        self._configs["nms_threshold"]   = 0.3
        self._configs["max_per_image"]   = 100
        self._configs["top_k"]           = 100
        self._configs["ae_threshold"]    = 0.3
        self._configs["nms_kernel"]      = 3

        self._configs["nms_algorithm"]   = "linear_soft_nms"
        ...
        self._configs["gaussian_iou"]    = [0.7,0.8]
